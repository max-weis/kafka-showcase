...
public class AppContainerConfig implements SharedContainerConfiguration {
  ...
  @Container
  public static final ApplicationContainer KAFKA_CONSUMER = new ApplicationContainer("kafka-showcase/kafka-consumer:0")
      .withNetwork(NETWORK)
      ...
      .withEnv("JAEGER_SERVICE_NAME", "kafka-consumer")
